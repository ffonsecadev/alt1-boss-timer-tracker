...
const imgs = ImageDetect.webpackImages({
	plusbutton: require("./assets/images/plusbutton.data.png"),
	minusbutton: require("./assets/images/minusbutton.data.png"),
	filterbutton: require("./assets/images/filterbutton.data.png"),
	chatbubble: require("./assets/images/chatbubble.data.png"),
	chatLegacyBorder: require("./assets/images/chatLegacyBorder.data.png"),
	entertochat: require("./assets/images/entertochat.data.png"),
	gameoff: require("./assets/images/gameoff.data.png"),
	gamefilter: require("./assets/images/gamefilter.data.png"),
	gameall: require("./assets/images/gameall.data.png"),
	legacyreport: require("./assets/images/legacyreport.data.png"),
	reportbutton: require("./assets/images/reportbutton.data.png"),
});

const chatbadges = ImageDetect.webpackImages({
	vip: require("./assets/images/badgevip.data.png"),
	pmod: require("./assets/images/badgepmod.data.png"),
	pmodvip: require("./assets/images/badgepmodvip.data.png"),
